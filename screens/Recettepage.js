...
/>
    <Text style={styles.title}>Choisis ta recette</Text>
      ...
      <Ionicons name="calendar" size={24} color='#dedede' style={styles.iconCalendar} />
      <Ionicons name="time" size={24} color='#dedede' style={styles.iconTime} />
      <Image
      ...
      <Image
        ...
        /> 
        <Ionicons name="heart" size={24} color='#dedede' style={styles.iconContent} />
             </View>
