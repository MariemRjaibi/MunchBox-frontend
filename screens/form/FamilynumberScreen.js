        ...
        <View style={styles.container}>
            ...
            <View style={styles.mainChoise}>
              ...
              <View style={[styles.containerChoice, styles.FirstcontainerChoice]}>
                  ...
                  <Image style={styles.imgAvatar} source={require('../../assets/icon/homme.png')} />
                  <View style={styles.containerCounter}>
                    <FontAwesome name="minus" size={10} color={'#92C3BC'}  onPress={() => counterClickmoins()}style={styles.btnCounter}/>
                    <Text style={styles.txtCounter}>{counterAdult}</Text>
                    <FontAwesome name="plus" size={10} color={'#92C3BC'}  onPress={() => counterClickPlus()} style={styles.btnCounter}/>
                  </View>      
              </View>

              <View style={styles.containerChoice} >
                  <Text style={styles.titleChoice}>Children</Text>
                  <Image style={styles.imgAvatar} source={require('../../assets/icon/garcon.png')} />
                  <View style={styles.containerCounter}>
                    <FontAwesome name="minus" size={10} color={'#92C3BC'}  onPress={() => counterPlusChildMoins()}style={styles.btnCounter}/>
                    <Text style={styles.txtCounter}>{counterChild}</Text>
                    <FontAwesome name="plus" size={10} color={'#92C3BC'}  onPress={() => counterPlusChildClick()} style={styles.btnCounter}/>
                  </View>      
              </View>
            </View>
