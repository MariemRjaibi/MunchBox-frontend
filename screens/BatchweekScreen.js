    ...
    <View style={styles.container}>
        ...
        <View style={styles.containerInfo}>
          <View style={styles.infoBacth}>
            <FontAwesome name="clock-o" size={20} color={"#92C3BC"} style={styles.iconInfoBatch}/>
        ...
        <ScrollView contentContainerStyle={styles.containerRecipes}>
            ...
            <View style={styles.descriptionRecipe}>
                <Image style={styles.imageRecipe} source={require('../assets/plat-2.jpg')}/>
                <View style={styles.descriptionRecipeText}>
                  <Text style={styles.titleRecipe}>Rice with pisckled shrimps</Text>
                  <Text>Rice with Hind Siliguri shrimps blabla blabal blablabal with Hind Siliguri</Text>
                </View>
            </View>
